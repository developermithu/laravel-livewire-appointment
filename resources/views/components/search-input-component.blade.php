<div class="form-group bmd-form-group ml-auto d-flex justify-content-between align-items-center ">
    <input {{$attributes}} type="text" class="form-control" placeholder="Search..">
    {{-- Spinner --}}
    <div wire:loading wire:target="search">
            <div class="la-line-spin-fade-rotating la-dark la-sm">
                <div></div>
                <div></div>
                <div></div>
                <div></div>
