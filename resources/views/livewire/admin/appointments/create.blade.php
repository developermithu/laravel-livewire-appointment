...
<div>
    <div class="row">
        <div class="col-md-10 m-auto">
            <form wire:submit.prevent="create" id="TypeValidation" class="form-horizontal" novalidate="novalidate">
              <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group bmd-form-group mt-4">
                          <input type="text" id="time" class="form-control" placeholder="H:M:S" wire:model="state.time">
                          @error('time')
                          <label class="error">{{$message}}</label>
                          @enderror
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group bmd-form-group" wire:ignore>
                         <textarea id="note" class="form-control w-100" wire:model="state.note"></textarea>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card-footer ml-auto mr-auto">
                  <button type="submit" class="btn btn-rose"> <span class="material-icons mr-1">save</span> Submit</button>
                </div>
              </div>
            </form>
          </div>
